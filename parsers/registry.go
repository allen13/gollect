...
import (
	...
	"github.com/allen13/gollect/parsers/json"
	"github.com/allen13/gollect/parsers/nagios"
	"github.com/allen13/gollect/parsers/influx"
	"github.com/allen13/gollect/parsers/graphite"
	"github.com/allen13/gollect/parsers/value"
)
...
type Parser interface {
	...
	Parse(buf []byte) ([]data.Metric, error)

	// ParseLine takes a single string metric
	// ie, "cpu.usage.idle 90"
	// and parses it into a telegraf metric.
	ParseLine(line string) (data.Metric, error)
