...
func (p *GraphiteParser) Parse(buf []byte) ([]data.Metric, error) {
...
func (p *GraphiteParser) ParseLine(line string) (data.Metric, error) {
	...
	return data.NewMetric(measurement, tags, fieldValues, timestamp)
}
