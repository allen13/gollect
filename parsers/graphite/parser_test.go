...
func TestFilterMatchDefault(t *testing.T) {
	...
	exp, err := data.NewMetric("miss.servers.localhost.cpu_load",
		map[string]string{},
...
func TestFilterMatchMultipleMeasurement(t *testing.T) {
	...
	exp, err := data.NewMetric("cpu.cpu_load.10",
...
func TestFilterMatchMultipleMeasurementSeparator(t *testing.T) {
	...
	exp, err := data.NewMetric("cpu_cpu_load_10",
		map[string]string{"host": "localhost"},
		map[string]interface{}{"value": float64(11)},
		time.Unix(1435077219, 0))
	assert.NoError(t, err)
...
func TestFilterMatchSingle(t *testing.T) {
	...
	exp, err := data.NewMetric("cpu_load",
		map[string]string{"host": "localhost"},
		map[string]interface{}{"value": float64(11)},
		time.Unix(1435077219, 0))
...
func TestParseNoMatch(t *testing.T) {
	...
	exp, err := data.NewMetric("servers.localhost.memory.VmallocChunk",
		map[string]string{},
		map[string]interface{}{"value": float64(11)},
		time.Unix(1435077219, 0))
	assert.NoError(t, err)
