...
func (p *JSONParser) Parse(buf []byte) ([]data.Metric, error) {
	...
	metric, err := data.NewMetric(p.MetricName, tags, f.Fields, time.Now().UTC())
...
func (p *JSONParser) ParseLine(line string) (data.Metric, error) {
